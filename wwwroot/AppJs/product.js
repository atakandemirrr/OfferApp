...
//sayfadaki modalı açmak için yapıldı ancak global js deki function u kullanıyorum.
...
///düzenle butonuna tıklayınca gelir
...
//modal içerisindeki kaydet butonuna tıklayınca
...
function FillOutList() {
    ...
    $.ajax({
        ...
        error: function (xhr, status, error) {
            // istek başarısız olduğunda çalışacak fonksiyon
...
function excelDosyaYukle() {
    ...
    if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
            ...
            // Excel tablosundan sadece ilk 4 sütunu al ve boş satırları atla
            var html = "";
...
///TABLODAN AL VERİTABANINA KAYDET
